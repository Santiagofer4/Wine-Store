...
{
  /* <TextField id="standard-basic" label="Marca" onChange={(e) => {setinputSearch(e.target.value);}}/>
        <TextField id="standard-basic" label="Bodega" onChange={(e) => {setinputSearch(e.target.value);}}/>
        <TextField id="standard-basic" label="Cepa" onChange={(e) => {setinputSearch(e.target.value);}}/> */
}
