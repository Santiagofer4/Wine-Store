...
function StrainForm() {
    ...
    <div className='formProd'>
        <form onSubmit={(e) => {handleOnSubmit(e)}} className="SearchBar__form" noValidate autoComplete="off">
            <TextField id={state.name ? 'accepted' : 'error'}        name='name'        label="Nombre Cepa"  type='string' onChange={(e) => {handleOnChange(e)}}/>
            <TextField id={state.pairing ? 'accepted' : 'error'}     name='pairing'     label="Maridaje"     type='string' onChange={(e) => {handleOnChange(e)}}/>
            <TextField id={state.description ? 'accepted' : 'error'} name='description' label="Descripcion"  type='string' onChange={(e) => {handleOnChange(e)}}/>
            <TextField id={state.origin ? 'accepted' : 'error'}      name='origin'      label="Origen"       type='string' onChange={(e) => {handleOnChange(e)}}/>
