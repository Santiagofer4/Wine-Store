...
import {  userOrdersSelector ,userOrdersStatusSelector, userSelector, reviewsListSelector} from "../../selectors/index.js";
          ...
          <Table aria-label="collapsible table">
            ...
            <TableBody>
              { allUserOrders = orders.map((row) => (
                <Row key={row.id} row={row.orderLines} order={row} review={row.status === 'completed' ? true : false}/>
              ))}
            </TableBody>
          </Table>
        </TableContainer>
